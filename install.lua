...
local function install()
    ...
    term.clear()
    centerText("envMod Installer", 2)

    updateStatus("Loading manifest...")
    drawProgressBar(0)

    local manifestUrl = "https://raw.githubusercontent.com/SpartanSf/envMod/master/manifest.txt"
    ...
    for i, step in ipairs(steps) do
        ...
        if step.type == "file" then
            ...
            local fileUrl = "https://raw.githubusercontent.com/SpartanSf/envMod/master/" .. step.remote
